...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? 'SUPUN-MD=WEsTHCIA#2SRrY1vrcao8CwACV8FqftjrNkdWTzjM5aSSKWaol8E' : process.env.SESSION_ID,
...
AUTO_STATUS__MSG: process.env.AUTO_STATUS__MSG === undefined ? "`𝒀𝒐𝒖𝒓 𝒔𝒕𝒂𝒕𝒖𝒔 𝒔𝒆𝒆𝒏 𝒋𝒖𝒔𝒕 𝒏𝒐𝒘 `" : process.env.AUTO_STATUS__MSG,
...
FOOTER: process.env.FOOTER === undefined ? "> |මිහිරාවී 𝗦𝗧𝗔𝗧𝗨𝗦 𝗖𝗛𝗔𝗡𝗡𝗘𝗟'' | 📍🇱🇰" : process.env.FOOTER,
...
TIKTOK_SEND_JID: process.env.TIKTOK_SEND_JID === undefined ? "120363400534364543@newsletter" : process.env.TIKTOK_SEND_JID,
